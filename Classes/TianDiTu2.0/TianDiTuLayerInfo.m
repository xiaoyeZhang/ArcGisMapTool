...
#define kURLGetTile @"http://t%ld.tianditu.gov.cn/%@/wmts?service=wmts&request=gettile&version=1.0.0&layer=%@&STYLE=default&tilematrixset=%@"

#define tiandituURL @"http://t%ld.tianditu.gov.cn/%@/wmts"
...
//    build lods for loop from 0 to 17 level
    for(int i= _minZoomLevel; i < _maxZoomLevel ;i++){
