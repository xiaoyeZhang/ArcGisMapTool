...
/** Block that is invoked whenever a KML node's balloon visibility changes.
 @note The block will be invoked on the same thread on which the event occurred, which could be any
 arbitrary thread. You need to dispatch any UI related work to the main thread.
 @since 100.5
 */
@property (nullable, nonatomic, copy, readwrite) void (^nodeBalloonVisibilityChangedHandler)(AGSKMLNode *node, BOOL balloonVisibility);
