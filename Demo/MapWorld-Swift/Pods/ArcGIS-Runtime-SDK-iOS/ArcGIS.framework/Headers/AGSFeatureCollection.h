...
/** @brief A lightweight collection of features
 ...
 The feature collection may be created and stored as part of a map or as a separate item (of type @c AGSPortalItemTypeFeatureCollection) on ArcGIS Portal. You can also programmatically create an empty feature collection and then add tables and features to it.
 @since 100
...
/** Initialize the feature collection with the provided item. The item must be of type @c AGSPortalItemTypeFeatureCollection.
 @param item of type @c AGSPortalItemTypeFeatureCollection that represents the feature collection
