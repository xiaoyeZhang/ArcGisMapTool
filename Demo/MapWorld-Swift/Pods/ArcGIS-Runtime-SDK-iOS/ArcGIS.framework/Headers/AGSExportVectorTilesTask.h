...
/** Initialize the task with an item on ArcGIS Online or ArcGIS Portal representing an ArcGIS Vector Tile layer. The item's type must be @c AGSPortalItemTypeVectorTileService.
...
/** Initialize the task with an item on ArcGIS Online or ArcGIS Portal representing an ArcGIS Vector Tile layer. The item's type must be @c AGSPortalItemTypeVectorTileService or the task will fail to load.
 @note The Vector Tile service referred to by the item must have the export tiles capability enabled. See `AGSVectorTileSourceInfo#exportTilesAllowed`
 @param portalItem representing an ArcGIS Vector Tile layer.
 @return initialized task
 @since 100.2
...
/** Portal item representing an ArcGIS vector tile service. The item's type must be @c AGSPortalItemTypeVectorTileService.
