...
@interface AGSMarkerSymbol (AGSDeprecated)

/**
 The rotation type of the marker symbol.
 
 The default value is `AGSSymbolRotationTypeArithmetic`. This property is
 deprecated in release 100.5.
 
 @since 100
 @deprecated 100.5 Will be removed in a future release. There is no other
 mechanism to specify the rotation type, but all angles are achievable by
 changing the value of the @c angle property.
 */
@property (nonatomic, assign, readwrite) AGSSymbolRotationType rotationType __deprecated;
