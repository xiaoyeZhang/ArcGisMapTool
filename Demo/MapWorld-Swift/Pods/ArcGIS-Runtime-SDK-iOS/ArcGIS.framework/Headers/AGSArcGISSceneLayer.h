...
/** Initialize this layer with an item representing an individual layer in an ArcGIS Scene Service. The item's type should be @c AGSPortalItemTypeSceneService.
...
/** Returns the content data type of the scene layer.
 @since 100.5
 */
@property (nonatomic, assign, readonly) AGSSceneLayerDataType dataType;
