...
/** The optional image used for displaying content to the left of the text labels.
 The image will be scaled to 30x30 points.
 @since 100
 */
@property (nullable, nonatomic, strong) AGSImage *image;

/** This is a parameter that specifies that the width of the callout should adjust to the size
 of the text. This parameter is ignored if using a custom view. The default is @c YES.
 @since 100
 */
...
/** Callout's border color. Default is @c lightGrayColor with @c 0.9 alpha.
 @since 100
 */
@property (nullable, nonatomic, strong) AGSColor *borderColor;

/** Callout's border width. Default is @c 0.5.
 @since 100
 */
...
/** Background color of callout. Default is @c whiteColor with @c 0.9 alpha.
 @since 100
 */
@property (nonatomic, strong) AGSColor *color;

/** Highlight color of callout. Default is @c nil.
 @since 100
 */
@property (nullable, nonatomic, strong) AGSColor *highlight;

/** Text color. Default is @c blackColor.
 @since 100
 */
@property (nonatomic, strong) AGSColor *titleColor;

/** Detail text color. Default is @c blackColor.
 @since 100
 */
...
/** The maximum width of the callout if the callout is autosizing to the text.
 ...
 if using a custom view. The default value is @c 300.
 @since 100
 */
