...
@class AGSMultilayerPointSymbol;
...
#pragma mark methods
/**
 Returns the multilayer point symbol generated from simple marker symbol. The resulting symbol contains a single `AGSVectorMarkerSymbolLayer` that has a `AGSVectorMarkerSymbolElement` with a polygon representation of the marker geometry.
 
 @return Multilayer point symbol
 @since 100.5
 */
