...
/** Initialize a tiled elevation source based on an ArcGIS Image service or a
 local Tile Package (.tpk or .tpkx file) on disk containing elevation data.
 @param URL The URL to a tiled ArcGIS Image service or a local Tile Package
 (.tpk or .tpkx file) on disk containing elevation data.
 @return A new tiled elevation source.
 @since 100
 */
-(instancetype)initWithURL:(NSURL*)URL;

/** Initialize a tiled elevation source with the name of a local Tile Package
 (.tpk or .tpkx file) within the application bundle or shared documents
 directory containing elevation data.
 @param name The name of a local Tile Package (same as the name of the .tpk or
 .tpkx file without the file extension) containing elevation data.
 @return A new tiled elevation source
 @since 100.1
 */
