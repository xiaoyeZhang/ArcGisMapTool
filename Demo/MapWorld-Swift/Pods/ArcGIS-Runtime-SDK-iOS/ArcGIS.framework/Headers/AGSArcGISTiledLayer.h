...
/** @brief A layer based on a tiled ArcGIS Map service.
 ...
 An instance of this class allows you to display maps from a tiled ArcGIS Map
 service, tiled ArcGIS Image service, or a local Tile Package (.tpk or .tpkx
 file). It uses a cache of pre-generated tiles to assemble a map instead of
...
/** Initialize this layer with a URL of a tiled ArcGIS Map or Image service, or
 a file URL to a Tile Package (.tpk or .tpkx file) on disk.
 
 @param URL A URL to a tiled ArcGIS Map or Image service, or a file URL to a
 Tile Package (.tpk or .tpkx file) on disk.
 @return A new tiled layer object.
 @since 100
 */
-(instancetype)initWithURL:(NSURL*)URL;

/** Initialize this layer with the name of a Tile Package (.tpk or .tpkx file)
 within the application bundle or shared documents directory.
 @param name The name of the Tile Package (without the .tpk or .tpkx file
 extension) within the application bundle or shared documents directory.
 @return A new tiled layer object.
 @since 100.2
 */
-(instancetype)initWithName:(NSString*)name;

/** Initialize this layer with a tile cache representing a local Tile Package
 (.tpk or .tpkx file).
 @param tileCache An @c AGSTileCache object representing a local Tile Package
 (.tpk or .tpkx file).
 @return A new tiled layer object.
 @since 100
 */
...
/** Initialize this layer with a URL of a tiled ArcGIS Map or Image service or a
 file URL to a Tile Package (.tpk or .tpkx file) on disk.
 @param URL The URL to a tiled ArcGIS Map or Image service or a file URL to a
 Tile Package (.tpk or .tpkx file) on disk.
 @return A new tiled layer object.
 @since 100
 */
