...
/** @brief A cache of map tiles in a Tile Package
 ...
 Instances of this class represent a cache of map tiles in a local Tile Package
 (.tpk or .tpkx file).
...
/** Initialize this object with a path to a local Tile Package (.tpk or .tpkx
 file).
 @param fileURL The URL to a local Tile Package (.tpk or .tpkx file).
 @return An initialized tile cache.
 @since 100
 */
-(instancetype)initWithFileURL:(NSURL*)fileURL;

/** Initialize this object with the name of a local Tile Package (.tpk or .tpkx
 file) within the application bundle or shared documents directory.
 @param name The name of a local Tile Package (same as the name of the .tpk or
 .tpkx file without the file extension).
 @return An initialized tile cache.
 @since 100
 */
...
/** The file URL of the Tile Package (.tpk or .tpkx file) being used by this
 tile cache.
 @since 100
 */
