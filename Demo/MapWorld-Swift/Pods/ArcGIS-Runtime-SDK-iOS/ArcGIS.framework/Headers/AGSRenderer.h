...
/** Return a symbol for the feature based on the scheme used by this renderer and optionally apply attribute overrides.
 @param feature The feature to determine the symbol for.
 @param applyAttributeOverrides If set true, applies the override attributes from the renderer.
 @return Symbol for feature.
 @since 105
 */
-(AGSSymbol*)symbolForFeature:(AGSFeature*)feature applyAttributeOverrides:(BOOL)applyAttributeOverrides;
...
/** Return a symbol for the graphic based on the scheme used by this renderer and optionally apply attribute overrides.
 @param graphic The graphic to determine the symbol for.
 @param applyAttributeOverrides If set true, applies the override attributes from the renderer.
 @return Symbol for graphic.
 @since 100.5
 */
-(AGSSymbol*)symbolForGraphic:(AGSGraphic*)graphic applyAttributeOverrides:(BOOL)applyAttributeOverrides;
