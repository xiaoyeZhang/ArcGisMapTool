...
#import <ArcGIS/AGSSymbolAnchor.h>
...
#import <ArcGIS/AGSElevationServiceInfo.h>
...
#import <ArcGIS/AGSIntegratedMeshLayer.h>
#import <ArcGIS/AGSPointCloudLayer.h>
#import <ArcGIS/AGSGroupLayer.h>
#import <ArcGIS/AGSAnnotationLayer.h>
...
// WFS
#import <ArcGIS/AGSWFSFeatureTable.h>
#import <ArcGIS/AGSWFSService.h>
#import <ArcGIS/AGSWFSServiceInfo.h>
#import <ArcGIS/AGSWFSLayerInfo.h>
...
#import <ArcGIS/AGSGeometricEffect.h>
#import <ArcGIS/AGSDashGeometricEffect.h>
#import <ArcGIS/AGSSymbolLayer.h>
#import <ArcGIS/AGSMarkerSymbolLayer.h>
#import <ArcGIS/AGSFillSymbolLayer.h>
#import <ArcGIS/AGSStrokeSymbolLayer.h>
#import <ArcGIS/AGSSolidStrokeSymbolLayer.h>
#import <ArcGIS/AGSPictureMarkerSymbolLayer.h>
#import <ArcGIS/AGSVectorMarkerSymbolElement.h>
#import <ArcGIS/AGSVectorMarkerSymbolLayer.h>
#import <ArcGIS/AGSSolidFillSymbolLayer.h>
#import <ArcGIS/AGSHatchFillSymbolLayer.h>
#import <ArcGIS/AGSPictureFillSymbolLayer.h>
...
#import <ArcGIS/AGSExpiration.h>

// Mobile Scene Package
#import <ArcGIS/AGSMobileScenePackage.h>
...
#import <ArcGIS/AGSKMLTourController.h>
...
#import <ArcGIS/AGSOfflineSettings.h>
...
/** @mainpage Introduction
 ...
 You need to use a minimum of iOS 12 SDK to build your applications. Also, the applications you build will require a minimum of iOS 11 running on the device.
 ...
 - Add <b>pod 'ArcGIS-Runtime-SDK-iOS', '100.5'</b> to your Podfile.
 ...
 Drag and drop the `ArcGIS.framework` file from `${HOME}/Library/SDKs/ArcGIS/iOS/Frameworks/Dynamic` directory into the <b>Embedded Binaries</b> section of your project's <b>General</b> settings.
 
 Switch to the <b>Build Phases</b> tab of your target's settings, click the <b>+</b> to add a new <b>Run Script Phase</b>. Then paste in the following text : `bash "${BUILT_PRODUCTS_DIR}/${FRAMEWORKS_FOLDER_PATH}/ArcGIS.framework/strip-frameworks.sh"`
 ...
 You need to use a minimum of macOS 10.14 SDK to build your applications. Also, the applications you build will require a Mac running a minimum of macOS High Sierra (10.13).
 
 @section sec1 Setting up your Xcode project using CocoaPods
 
 If you're already using <a target="_blank" href="http://cocoapods.org/">CocoaPods</a>, setting up your project to use ArcGIS is really easy.
 
 - Add <b>pod 'ArcGIS-Runtime-SDK-macOS', '100.5'</b> to your Podfile.
 - Run the command <b>pod install</b> on the Podfile using the Terminal application.
 - Open the project workspace (*.xcworkspace file) and add the <b>#import &lt;ArcGIS/ArcGIS.h&gt;</b>  statement to any class files where you wish to use the API.
 ...
 under `${HOME}/Library/SDKs/ArcGIS/macOS`.
 ...
 You must also add the <i>ArcGIS.bundle</i> file found under <i>${HOME}/Library/SDKs/ArcGIS/macOS/Frameworks/Static/ArcGIS.framework/Resources</i> to your project. This bundle file contains the resources (images, localized strings, etc) used by the API.
