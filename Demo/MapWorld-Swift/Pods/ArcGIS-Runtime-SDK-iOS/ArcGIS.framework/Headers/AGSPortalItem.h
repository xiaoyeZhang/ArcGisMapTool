...
@interface AGSPortalItem (AGSDeprecated)
...
/** The GUID of this portal item.
 @since 100
 @deprecated 100.5 No replacement because this property is not useful. @c AGSItem.itemID provides a unique identifier of the item.
 */
@property (nonatomic, copy, readonly) NSString *GUID __deprecated;
